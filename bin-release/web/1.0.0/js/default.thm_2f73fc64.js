                ...
                generateEUI.skins = undefined;generateEUI.paths['resource/skins/Bao.exml'] = window.$exmlClass1 = (function (_super) {
	...
	function $exmlClass1() {
		...
		this.height = 900;
		this.width = 1440;
		this.elementsContent = [this._Rect1_i(),this.bg_i()];
	}
	...
	return $exmlClass1;
})(eui.Skin);generateEUI.paths['resource/skins/SceneStartSkin.exml'] = window.SceneStartSkin = (function (_super) {
	__extends(SceneStartSkin, _super);
	function SceneStartSkin() {
		_super.call(this);
		this.skinParts = ["time","gameBg","niu","stuScene","time2","time1","time4","time3","group","djsTime","djs","pro","pros","socker","tip","teacherName","teacherInfor"];
		
		this.height = 900;
		this.width = 1440;
		this.time_i();
		this.elementsContent = [this.gameBg_i(),this.niu_i(),this.stuScene_i(),this.group_i(),this.djs_i(),this._Group1_i(),this.socker_i(),this.tip_i(),this.teacherInfor_i()];
...
})(eui.Skin);generateEUI.paths['resource/skins/Socker.exml'] = window.$exmlClass2 = (function (_super) {
	...
	return $exmlClass2;
})(eui.Skin);generateEUI.paths['resource/skins/StuList.exml'] = window.$exmlClass3 = (function (_super) {
